...
public class Arvore implements IArvore, Serializable{
     ...
     * @throws DadoNaoEncontradoException Caso o elemento a ser procurado não seja encontrado.
     ...
     * @throws DadoDuplicadoException Caso o <b>Item</b> que está sendo inserido
        ...
        if(isEmpty()){ //Caso a Árvore esteja vazia, insere na Raiz.
            ...
            while(pai != null){
                if(item.compareTo(pai.getDados()) == 0){
                    throw new DadoDuplicadoException(item);
                }
     ...
     * 
     * @throws DadoNaoEncontradoException Caso o elemento passado como parâmetro não exista na <b>Árvore</b>.
     */
    @Override
